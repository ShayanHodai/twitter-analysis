"""
this module calculate sentiment [0, 1) using hugging face bert transformer
"""
...
def bert_transformer(text):
    """
    hugging face pre trained transformer model called bert specifically trained to do sentiment analysis on tweets
